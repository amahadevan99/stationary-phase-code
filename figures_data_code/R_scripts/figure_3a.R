...
p <- ggplot(df, aes(x = .data[[X_VAR]], y = .data[[Y_VAR]], color = ancestor_label, shape = ploidy_consensus)) +
    ...
    geom_text(
        ...
        inherit.aes = FALSE,
        hjust = 0, vjust = 1, size = 5, show.legend = FALSE
    ) +
...
ggsave("figures/fig_3a.pdf", p, width = 10, height = 8)
