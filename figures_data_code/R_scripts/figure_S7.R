...
p <- ggplot(df, aes(
    ...
    # --- MODIFIED: Removed the data filter from both geom_smooth layers ---
    ...
    scale_shape_manual(
        ...
        breaks = c("haploid", "diploid", "undetermined"),
        na.value = 4
    ) +
...
ggsave("figures/fig_S7.pdf", p, width = 12, height = 10)
